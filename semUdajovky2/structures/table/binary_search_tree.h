...
namespace structures
{
	...
	inline void BinarySearchTree<K, T>::insert(const K & key, const T & data)
	{
		...
		BinaryTreeNode<TableItem<K, T>*>* binaryTreeNode = new BinaryTreeNode<TableItem<K, T>*>(tableItem);
	...
	{
		bool found = false;
		BSTTreeNode* binaryTreeNode = findBSTNode(key, found);
	...
	{
		return new BinaryTree<TableItem<K, T>*>::InOrderTreeIterator(this->binaryTree_->getRoot());
	}
	...
	inline typename BinarySearchTree<K,T>::BSTTreeNode* BinarySearchTree<K, T>::findBSTNode(const K & key, bool & found) const
	{
		...
		{
			BinaryTreeNode<TableItem<K, T>*>* node = dynamic_cast<BinaryTreeNode<TableItem<K, T>*>*>(this->binaryTree_->getRoot());
